...
export class CreateSensorDto {
  ...
  @ApiProperty({ description: 'Сфера применения' })
  readonly application_sphere: string;

  @ApiProperty({ description: 'Датчик' })
  readonly environment: string;

  @ApiProperty({ description: 'Литература' })
  readonly literature: string;

  @ApiProperty({ description: 'Датчик' })
  readonly measurable_value: string;

  @ApiProperty({ description: 'Датчик' })
  readonly type: string;

  @ApiProperty({ description: 'Датчик' })
  readonly signal_conversation: string;

  @ApiProperty({ description: 'Датчик' })
  readonly output_signal: string;
  ...
  @ApiProperty({ description: 'Датчик' })
  readonly sensitive_element: string;
}
